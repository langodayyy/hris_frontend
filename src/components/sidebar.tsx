...
=======
        className={`fixed top-0 left-0 h-full bg-white text-neutral-900 border-r-2 border-neutral-200 
>>>>>>> d4281c25a24fe7fe385e3c5c9f92d4700343930d
        ${isOpen ? "w-64" : "w-[77px]"} 
...
=======
        <div className="flex items-center justify-center pt-4 pb-[30px] ">
          <Image
            src={isOpen ? "/images/logo hris with text.png" : "/images/logo hris with no text.png"}
            alt="Logo"
            width={isOpen ? 82 : 33.75}
            height={isOpen ? 66 : 66}
            className={`transition-none duration-300  ${isOpen ? "" : ""}`}
          />
        </div>
