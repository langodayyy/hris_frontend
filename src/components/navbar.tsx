...
export default function Navbar({title, notificationCount = 0} : NavbarProps) {
  return (
    <nav className="fixed top-0 left-0 flex flex-row items-center w-full h-auto bg-white px-6 py-[16px] justify-between shadow-[0px_2px_4px_#B0B0B0]">
      <div className="flex justify-start w-[230px] h-[29px]">
        <a href="#" className="text-2xl font-medium text-left">{title}</a> 
      </div>
        <div className="flex flex-row items-center w-[400px] h-[36px] gap-[12px] relative">
          <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <path d="M18.3332 18.3333L16.6665 16.6666" stroke="#595959" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <Input type="text" id="search" placeholder="Search" className="w-[400px] h-[36px] pl-10 rounded-[8px] bg-[#F5F6F7]" />
        </div>
            ...
            <div className="flex items-center">
              <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M16.5999 7.45837L11.1666 12.8917C10.5249 13.5334 9.4749 13.5334 8.83324 12.8917L3.3999 7.45837" stroke="#444750" strokeWidth="1.25" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
            </div>
          </div>
