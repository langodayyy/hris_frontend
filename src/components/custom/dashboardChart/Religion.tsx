...
export function Religion({ dashboardData }: Props) {
      ...
      <CardContent className="flex flex-row w-full pb-0">
        ...
        <div className="py-[20px] w-full">
          <div className="border-b-2 border-neutral-100 pb-[20px]">
            ...
            <div className="font-bold text-lg">Religion</div>
          </div>
          ...
          <div className="flex flex-col gap-[10px] pt-[20px]">
            {hasDataForChart ? ( // Hanya tampilkan summary jika ada data untuk chart
              ...
              <p className="text-gray-500 italic my-15 justify-center flex">
                No employee religion data has been record.
              </p>
            )}
          </div>
        </div>
