    ...
    <div className="flex h-screen w-screen bg-white p-[23px]">
      {/* form  */}
        <div className="w-1/2 flex flex-col items-center justify-center px-[80px] py-[10px] gap-[25px] overflow-y-auto">
          ...
          <h4 className="text-[34px] font-medium text-neutral-900 text-center">Your password has been succesfully reset</h4>
          <p className="text-base text-neutral-500 text-center">You can log in with yournew password. If you encounter any issues, please contact support!</p>
