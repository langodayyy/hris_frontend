...
const employeeSchema = z.object({
    ...
    education: z.string()
                ...
                .refine(val => ['SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3'].includes(val), {
                message: 'Education must be one of SD, SMP, SMA, D3, S1, S2, or S3',
                }),
    blood_type: z.string()
    ...
    religion: z.string()
                ...
                .refine(val => ['Islam', 'Christian Protestant', 'Catholic', 'Hindu', 'Buddha', 'Confucianism', 'Other'].includes(val), {
                message: 'Religion must be one of Islam, Christian Protestant, Catholic, Hindu, Buddha, Confucianism or Other',
                }),
            ...
            <Card className="flex-1 mx-[20px] gap-[15px] rounded-[15px] border border-black/15 bg-white shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] overflow-hidden">
                ...
                <div className="flex mx-[20px] gap-[10px]">
                    <div className="flex flex-col flex-1 gap-[8px]">
                        ...
                        {errors().bank_code && <p className="text-red-500">{errors().bank_code[0]}</p>}
                        </div>
                    {/* <div className="flex flex-col flex-1 gap-[8px]">
                        <Label htmlFor="bank">Bank</Label>
                        <Select onValueChange={(value) => setSelectedBank(value)}>
